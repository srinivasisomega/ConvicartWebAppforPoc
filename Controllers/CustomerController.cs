...
namespace ConvicartWebApp.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> SignIn(SignInViewModel model)
        {
            ...
            var customer = await CustomerService.GetCustomerByEmailAndPasswordAsync(model.Email, model.Password);
            if (customer == null)
            {
...
public async Task<IActionResult> SignUp(SignUpViewModel model)
        {
            ...
            var existingCustomer = await CustomerService.GetCustomerByEmailAsync(model.Email);
        ...
        public IActionResult UpdateSubscription(string subscriptionType, int days, decimal amount, int customerId)
        {
            if (!SubscriptionService.UpdateSubscription(subscriptionType, days, amount, customerId, out string errorMessage))
            {
                ...
                return RedirectToAction("Subscription", new { customerId });
            }
